<template lang="jade">
  div.content-box
    lotteryDialog(v-if="dialog == true",@changeTableList="getRecordListData",:isMe="isMe",ref="aaa")
    .content
      div.header-search
